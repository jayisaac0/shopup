<?php
$page_title = "Catering service | View our large collection of cars";
$content = "Welcome and feel free to look at variuos catering servises and select desired service.";
?>
    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main" style="background:<?php echo $cateringcover->backgroundcolor; ?>;">
            ...
            <div class="">
                ...
                <div class="row" style="margin-top:-100px;width:90%;margin-left:auto;margin-right:auto;" id="">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="" style="height:300px;">
                            <div class="image  view-first" style="height:200px;">
                                ...
                                <h3><center><a href="cateringorder/<?php echo $shop->user_name; ?>">View</a></center></h3>
                                <p><center style="font-size:20px;"><?php echo $cateringcover->about; ?></center>
                                </p>
                                <h1><center>...</center></h1>
                                <h1><center>View our varieties and prices</center></h1><br />
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <i style="font-size:20px;font-family:fantasy;"><center><?php echo $cateringcover->servicedelivery; ?></center></i><br />
                                    </div>
                                        ...
                                        <div class="thumbnail" style="height:300px;background:<?php echo $cateringcover->containercolor; ?>;">
                                            <div class="image view view-first" style="height:200px;">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        <a href="#">Ksh <?php echo number_format($catering->cateringserviceprice, 2); ?></a><br />
                                                        <a href="#"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </div>
                                            </div>
