...
<div class="" role="main">
<h1><?php echo $catering->cateringservice; ?></h1> 
<div class="">
            ...
            <div class="">
                <div class="product_price">
                    ...
                    <form class="form-horizontal" role="form" method="POST" >
                            <?php
                                if(isset($_POST['removecateringproduct']))
                                {
                                    try
                                    {
                                        if($auth_user->deletecateringproduct($catering_id))
                                        {
                                            unlink($catering->cateringserviceimage);
                                            ?>
                        ...
                        <div class="caption ">
                            <p style = "text-align:center;"><button class="btn btn-danger btn-lg" name = "removecateringproduct" >Confirm delete</button></p>
                        </div>
                    </form>
