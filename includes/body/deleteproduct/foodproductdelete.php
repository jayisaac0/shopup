    ...
    <div class="x_content">
        <div class="col-md-7 col-sm-7 col-xs-12">
            <div class="product-image">
                <img src="<?php echo $food->snackimage; ?>" alt="" />
            </div>
        </div>
            ...
            <div class="">
                <div class="product_price">
                    ...
                    <form class="form-horizontal" role="form" method="POST" >
                            <?php
                                if(isset($_POST['removefoodproduct']))
                                {
                                    try
                                    {
                                        if($auth_user->deletefoodproduct($food_id))
                                        {
                                            unlink($food->snackimage);
                                            ?>
                        ...
                        <div class="caption ">
                            <p style = "text-align:center;"><button class="btn btn-danger btn-lg" name = "removefoodproduct" >Confirm delete</button></p>
                        </div>
                    </form>
