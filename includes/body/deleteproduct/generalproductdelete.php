...
<div class="" role="main">
<h1><?php echo $generalshop->productname; ?></h1> 
<div class="">
            ...
            <div class="">
                <div class="product_price">
                    ...
                    <form class="form-horizontal" role="form" method="POST" >
                            <?php
                                if(isset($_POST['removegeneralshopproduct']))
                                {
                                    try
                                    {
                                        if($auth_user->deletegeneralshopproduct($generalshop_id))
                                        {
                                            unlink($generalshop->productimage);
                                            ?>
                        ...
                        <div class="caption ">
                            <p style = "text-align:center;"><button class="btn btn-danger btn-lg" name = "removegeneralshopproduct" >Confirm delete</button></p>
                        </div>
                    </form>
