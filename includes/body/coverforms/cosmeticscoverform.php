<?php require_once 'includes/body/coverformscontroller/cosmeticscoverformccontroller.php'; ?>
<form class="form-horizontal"  role="form" method="POST" data-parsley-validate enctype="multipart/form-data">
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            ...
            <button type="submit" id="postcosmeticcover" name="postcosmeticcover" class="btn btn-success">Submit</button>
        </div>
    </div>
</form>
