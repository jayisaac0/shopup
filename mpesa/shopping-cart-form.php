<form action="pesapal-iframe.php" method="post">
	<table>
		<tr>
			<td>Amount:</td>
			<td><input type="text" name="amount" value="350" />
			(in Kshs)
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Description:</td>
			<td><input type="text" name="description" value="Subscription" /></td>
		</tr>
		<tr>
			<td>Reference:</td>
		...
		<tr>
			<td>Shopper's First Name:</td><?php print($userRow['shopname']); ?>
