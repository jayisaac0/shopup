                                            ...
                                            <div class="x_content">
                                                <div class="col-sm-3 col-md-3 col-xs-12">
                                                    ...
                                                    <ul class="nav nav-tabs tabs-left">
                                                        ...
                                                        <li><a href="generalshop/<?php echo $shop->user_name; ?>">Back</a>
                                                        </li>
                                                        <li><a  data-toggle=""><?php require_once 'includes/body/forms/addtocycle.php'; ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-2 col-md-9 col-xs-12" style="height:350px;">
                                                    <!-- Tab panes -->
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="home">
                                                            <div class="image view view-first" style="max-height:270px;width:100%;display: block;overflow:hidden;">
                                                              <img style="max-height:100%;width:100%;display: block;" src="images/beauty.jpg" alt="image" />
                                                                        ...
                                                                        <p><b>Price: <?php echo $shop->currency.' '; ?> 34000.00</b> <b style="float:right;">Discount: 15%</b></p>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row" style="margin-top:;width:98%;margin-left:auto;margin-right:auto;">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div style="height:300px;">
                            ...
                            <!-- page content -->
                                        <div class="col-md-12 ol-sm-12 col-xs-12" id="mypagecard">
                                        <nav class="navbar navbar-default">
                                ...
                                $stmt = $auth_user->runQuery("SELECT * FROM generalshop WHERE `user_name` = '$user' AND `productcategory`='$category' ");
                                $stmt->execute(array());
                                $generalshop=$stmt->fetchAll(PDO::FETCH_OBJ);
                                foreach ($generalshop as $generalshop) {
                                    ?>
