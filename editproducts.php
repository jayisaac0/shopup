                            ...
                            <?php
                                if($user->typeofbusiness == "generalshop")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/generaleditform.php';  ?>
                                        <?php
                                        }                                          
                                ...
                                else if($user->typeofbusiness == "cars")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/carseditform.php'; ?> 
                                        <?php
                                        }                                        
                                ...
                                else if($user->typeofbusiness == "hotels")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/hotelseditform.php';  ?>
                                        <?php
                                        }                                         
                                ...
                                else if($user->typeofbusiness == "food")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/foodeditform.php'; ?>
                                        <?php
                                        }                                        
                                ...
                                else if($user->typeofbusiness == "farming")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/farmingeditform.php'; ?>
                                        <?php
                                        }                                        
                                    ...
                                    {
                                        require_once 'includes/body/updateforms/healtheditform.php'; 
                                    }
                                else if($user->typeofbusiness == "catering")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/cateringeditform.php'; ?>
                                        <?php
                                        }
                                ...
                                else if($user->typeofbusiness == "cosmetics")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/cosmeticseditform.php'; ?>
                                        <?php
                                        }                                        
                                ...
                                //else if($user->typeofbusiness == "consultancy"){ require_once 'includes/body/updateforms/consultancyeditform.php'; }
                                else if($user->typeofbusiness == "education")
                                    {
                                        ...
                                        ?>
                                            <?php require_once 'includes/body/updateforms/educationeditform.php'; ?>
                                        <?php
                                        }                                           
